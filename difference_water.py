...
class Window(QtWidgets.QDialog):
    ...
    def save_to_dir(self,dir_name):
        ...
        filename = '{}\water_brom_exp_diff_{}.png'.format(dir_to_save,self.name)       
    ...
    def plot_3fig(self): 
        ...
        cmap = plt.get_cmap('viridis') #CMRmap
        cmap_water = cmap #
        ...
        #normalize = None
        #CS1 = ax0.pcolormesh(X,Y,var_water[:,start:stop], # norm = normalize,
